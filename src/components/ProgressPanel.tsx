...
export function ProgressPanel({ isRunning, percent, statusLabel, detailLabel, logs, completedItem, onReset, canReset }: ProgressPanelProps) {
  return (
    <SectionCard
      title="Run Console"
      eyebrow="Execution"
    ...
    >
      <div className="grid gap-4 lg:grid-cols-[300px_1fr]">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-fuchsia-500/15 via-cyan-500/10 to-amber-400/10 p-5">
          ...
          <div className="mt-4 text-3xl font-semibold text-white">{statusLabel}</div>
